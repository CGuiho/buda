---
subject: buda-docs
description: Durable Buda architecture, governing-reference, validation, and implementation documentation.
parent: buda-package
children: []
files: {}
documents:
...
implementation. It does not claim release or qmd-runtime validation that has
not been performed.
